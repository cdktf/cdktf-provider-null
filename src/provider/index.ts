// https://registry.terraform.io/providers/hashicorp/null/3.2.3/docs
...
export class NullProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing NullProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/null/3.2.3/docs#import import section} in the documentation of this resource for the id to use
